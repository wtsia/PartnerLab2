...
/**
 * DR.TT: A program that mimics ELIZA, a language processing program which
 * returns therapeutic statements
 * 
 * Group #10
 * 
...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		// create Hashmap for different feeling types that are associated with numbers
		// 1-10
		...
		/**
		 * while loop takes in filtered userInput as a lowercase string if userRating is
		 * an integer and meets && conditions, prints "Why do you feel ___?" and moves
		 * on else it queries for a proper number between 1-10 and scans
		 * 
		...
		/**
		 * While loop for programPhase == 1 filters the input and takes away punctiation
		 * and reduces it to a lowercase string. The words are then split by space and
		 * placed in an array For loop goes through string input array and if a match
		 * hits hashmap responseList, a question from that keyword is returned
		 */
